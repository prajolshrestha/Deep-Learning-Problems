...
class Trainer:
    ...
    def train_epoch(self):
        ...
        for x, y in self._train_dl:
            if self._cuda:
                x = x.cuda()
                y = y.cuda()
            loss = self.train_step(x,y) #training step
    ...
    def val_test(self):
        ...
        with t.no_grad():
            ...
            for x,y in self._val_test_dl:
                ...
                loss, pred = self.val_test_step(x,y) # validation step
    ...
    def fit(self, epochs=-1):
        ...
        while True:
            ...
            val_loss, val_metric = self.val_test() # Validation test
            ...
            epoch_n += 1
            print(f"Train loss: {train_loss} \tVal Loss: {val_loss} \tVal Metric: {val_metric}")
